...
parser.add_argument(
    ...
    default='/home/aizaz/ray_results/Adv_Env/IMPALA/MA-Inde-AdvIMPALATraining-SSUI3CCARLA/IMPALA_UrbanAdvPPOTraining-v0_3a45d932_2021-09-22_08-06-29hlk05jdm/checkpoint_150/checkpoint-150',
...
if args.redis_address is not None:
    ...
    # existing cluster
    ray.init(redis_address=args.redis_address,log_to_driver=False)#,object_store_memory=10**10
else:
    ray.init(num_gpus=args.num_gpus,log_to_driver=False)#,object_store_memory=10**10,log_to_driver=False)
...
# new_trainer.restore(args.checkpoint_path2)
# policyPPO = new_trainer.get_policy("car1A3C")
...
# trainer.get_policy("car2A3C").set_weights(weights_as_np_PPO)
...
if args.checkpoint_path2 and os.path.isfile(args.checkpoint_path2):
    trainer.restore(args.checkpoint_path2)
    print("Loaded checkpoint from:{}".format(args.checkpoint_path2))
...
agents_reward_dict = {'car1A3C': 0.0, 'car2A3C': 0.0, 'car3A3C': 0.0}
done = False
i=0
action = {}
with open("info_car1A3C.json", "w") as f1, open("info_car2A3C.json", "w")  as f2, open("info_car3A3C.json", "w") as f3 :
    ...
    while i < 2000:  # number of steps in a episodic run 
        ...
        step_reward=0
        step_reward += reward["car1A3C"]+reward["car2A3C"]+reward["car3A3C"]
        ...
        episode_reward += reward["car1A3C"]+reward["car2A3C"]+reward["car3A3C"]
