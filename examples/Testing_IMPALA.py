...
# Used only in debug mode
env_name_3 = "UrbanIMPALATraining-v0"
...
agents_reward_dict = {'car1IMPALA': 0.0,'car2IMPALA': 0.0,'car3IMPALA': 0.0}
done = False
i=0
action = {}
with open("info_car2IMPALA.json", "w") as f1:
    ...
    while i < 2000:  # number of steps in a episodic run 
        ...
        reward["car1IMPALA"] = 0.0
        reward["car3IMPALA"] = 0.0
        step += 1
        # sum up reward for all agents
        step_reward=0
        step_reward += reward["car2IMPALA"]
        ...
        episode_reward += reward["car2IMPALA"]
