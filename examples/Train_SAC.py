...
from ray.rllib.agents.sac.sac_policy import SACTFPolicy #0.8.5
...
# === Model ===
    ...
    "prioritized_replay_beta_annealing_timesteps": 100,
   ...
   # "gamma": 0.99,
    ...
    # pprint (config)
    return (SACTFPolicy, Box(0.0, 255.0, shape=(84, 84, 3)), Discrete(9),config)
        ...
        config= {
                ...
                #    "num_sgd_iter": 4,  # Enables Experience Replay
                    "multiagent": {
                        ...
                        "policy_mapping_fn":
                        tune.function(lambda agent_id: agent_id),
                        "policies_to_train": ["car2SAC"], #car2PPO is Autonomous driving models
                    },
                    "env_config": env_actor_configs,
                    "num_workers": args.num_workers,
                    "num_envs_per_worker": args.envs_per_worker,
