...
# Used only in debug mode
env_name_3 = "UrbanA2CTraining-v0"
...
agents_reward_dict = {'car1A2C': 0.0,'car2A2C': 0.0,'car3A2C': 0.0}
done = False
i=0
action = {}
with open("info_car2A2C.json", "w") as f1:
