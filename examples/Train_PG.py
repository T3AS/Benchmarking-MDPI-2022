...
if args.debug:
    ...
    analysis = tune.run(
        ...
        config= {
                    "env": env_name,
                    "log_level": "DEBUG",
                #    "num_sgd_iter": 4,  # Enables Experience ReplayPG
                    "multiagent": {
                        "policies": {
                            id: default_policy()
                            for id in env_actor_configs["actors"].keys()
                        ...
                        "policy_mapping_fn":
                        tune.function(lambda agent_id: agent_id),
                        "policies_to_train": ["car2PG"], #car2PPO is Autonomous driving models
                    },
                    "env_config": env_actor_configs,
                    "num_workers": args.num_workers,
                    "num_envs_per_worker": args.envs_per_worker,
