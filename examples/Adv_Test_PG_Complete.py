...
parser.add_argument(
    ...
    default='/home/aizaz/ray_results/Adv_Env/PG/MA-Inde-AdvPGTraining-SSUI3CCARLA/PG_UrbanAdvPPOTraining-v0_0_2021-09-22_05-35-40t2vkic5s/checkpoint_150/checkpoint-150',
...
def default_policy():
   ...
   # "gamma": 0.99,
    ...
    # pprint (config)
    return (PGTFPolicy, Box(0.0, 255.0, shape=(84, 84, 3)), Discrete(9),config)
