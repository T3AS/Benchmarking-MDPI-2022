...
def default_policy_4():
    env_actor_configs_4["env"]["render"] = False
        ...
        "MA-Inde-PPO-A2C-SSUI3CCARLA": {
            ...
            "config": {
                ...
                "multiagent": {
                    ...
                    "policies_to_train": ["car2PPO","car2A2C","car2A3C","car2PG","car2IMPALA","car2DQN"], #car2 and car3 are the victim Autonomous driving models
                },
                # "env_config": env_actor_configs,
                "num_workers": args.num_workers,
                "num_envs_per_worker": args.envs_per_worker,
