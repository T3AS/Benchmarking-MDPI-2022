...
from ray.rllib.agents.ddpg.ddpg_tf_policy import DDPGTFPolicy #0.8.5
...
env_name = "UrbanSignalIntersection3Car-v0"
...
def env_creator(env_config):
    ...
    import macad_gym
    env = gym.make("UrbanSignalIntersection3Car-v0")
                ...
                "config": {
                   ...
                   # "num_sgd_iter": 10,  # Enables Experience Replay
                    "multiagent": {
                        ...
                        "policy_mapping_fn":
                        tune.function(lambda agent_id: agent_id),
                        "policies_to_train": ["car2DDPG"], #car2 and car3 are the victim Autonomous driving models
                    },
                    "env_config": env_actor_configs,
                    "num_workers": args.num_workers,
                    "num_envs_per_worker": args.envs_per_worker,
